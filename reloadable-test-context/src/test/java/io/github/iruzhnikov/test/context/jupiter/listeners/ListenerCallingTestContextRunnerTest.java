...
@TestContextListener(include = ListenerCallingTestContextRunnerTest.ReloadableListenersCallTest.class)
...
class ListenerCallingTestContextRunnerTest {
    ...
    void testContextReloading(Injector injector) {
        assertNotNull(injector);
    }

    public static class ReloadableListenersCallTest extends ListenersTestUtils.AbstractListenersCallTest {
        public ReloadableListenersCallTest() {
            super(ReloadableTestContextListener.class);
        }
    }
}
